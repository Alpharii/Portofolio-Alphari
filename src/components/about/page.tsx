    ...
    return (
        <div className="mt-52 mb-32 px-4 sm:px-8 lg:px-16">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center space-x-0 sm:space-x-20 mt-20">
                <div className="block max-w-2xl p-5 px-10 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 font-poppins font-normal text-xl sm:text-base">
                ...
                <img src={programming.src} className="w-52 h-52 object-cover mt-4 sm:mt-0" alt="Programming" />
            </div>
        </div>
    );
}
